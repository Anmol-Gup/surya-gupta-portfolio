...
const Header: React.FC = () => {
  ...
  return (
    <>
      <Progress />
      <header className={`sticky top-0 z-40 w-full lg:px-10 xl:px-20 lg:py-3 px-6 py-4 items-center flex justify-between bg-[#0b132b] ${navColor ? 'lg:bg-[#3a506b]' : 'lg:bg-[#0b132b]'}`}>
